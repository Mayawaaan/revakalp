...
const SubCategoryPage = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-[#fffafc] via-[#fff1f4] to-[#ffe6ee] py-10 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-10 max-w-3xl mx-auto">
          <h1 className="font-serif text-2xl md:text-3xl text-pink-900">
            {heading}
          </h1>
        ...
        <Breadcrums />
        <Link to="/shop" className="text-pink-600 underline mb-8 inline-block">
          Back to Shop
        </Link>
        {/* Types Grid */}
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-xl bg-white">
                ...
                <img
                  src={type.image}
                  alt={type.name}
                  className="w-full h-72 object-cover transition-transform duration-700 group-hover:scale-120"
                />
